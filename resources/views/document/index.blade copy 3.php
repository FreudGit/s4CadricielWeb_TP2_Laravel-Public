...
<div class="row mt-3"> <div class="col-12"> <div class="card transparent-background"> <div class="card-header
    transparent-background"> <div class="float-start"> <h4>@lang('lang.documents_title')</h4> </div>
    <div class="float-end"> <a href="{{ route('document.create') }}" class="btn btn-dark ml-auto"> @lang('lang.btn_add')
        </a> </div> </div>
    <div class="card-body transparent-background">
        <table class="table table-bordered"> <thead> <tr>
            <th>@lang('lang.document_item_title')</th> <th>@lang('lang.document_item_dateadded')</th> <th>
